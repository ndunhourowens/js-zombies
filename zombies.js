...
Player.prototype.getPack = function() {  //seting a property for people to get access to the pack
  return this._pack;
};
...
Player.prototype.useItem = function(item){
  // call function to equip item IF weapon
  if (item instanceof Weapon){
    this.equip(item);
  // call function to eat IF food;
...
Player.prototype.equippedWith = function() {
  if (this.equipped === false) {
    console.log('you dont have anything to fight with');
    return false;
  }else {
    console.log('you have a ', this.equipped.name, ' to fight with');
